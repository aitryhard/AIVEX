      ...
      {profileCreatorOpen && (
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              setNewProfile((prev: typeof newProfile) => ({
                ...prev,
                name: e.target.value,
              }))
            }
          ...
          <div className="mt-4 flex gap-2">
            <button
              onClick={() => setNewProfile((prev: typeof newProfile) => ({ ...prev, prompt: "" }))}
            ...
            <button
              onClick={() => setNewProfile((prev: typeof newProfile) => ({ ...prev, prompt: prev.prompt || "Ты — полезный AI-ассистент Aivex." }))}
              className={`flex-1 py-2 rounded-xl text-xs font-medium transition ${
                useCustomPrompt
                  ? "bg-white text-black"
                  : "border border-white/[0.06] bg-white/[0.015] text-white/40 hover:text-white/60"
