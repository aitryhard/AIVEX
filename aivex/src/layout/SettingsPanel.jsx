...
const FREE_THEMES = ["Midnight", "AMOLED", "Slime"];
            ...
            <div>
              ...
              <div className="relative">
                <div
                  ...
                  className="grid grid-cols-3 gap-2 max-h-[170px] overflow-y-auto scrollbar-hide pt-1"
                >
            ...
            <div>
              ...
              <div className="rounded-2xl border border-white/[0.06] bg-white/[0.015] p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs text-white/50">Фон панели</span>
                  <span className="text-xs text-white/30 font-medium">{uiSettings.opacity}%</span>
                </div>
                <input
                  type="range"
                  min="15"
                  ...
                  className="no-drag w-full accent-white/60 focus:outline-none"
                />
              </div>
            </div>
